...
base_url <- "https://api.sportmonks.com/v3/football/teams/seasons/21646?include=players.player"
...
api_key <- "ZsmqzVHh2cx0AcBaTlnKuV4Wh3XuYSlyYuh6yEDLULKpPa42fnbggIIubhNL"
headers <- c("Authorization" = api_key, "Accept" = "application/json")
current_pl_teams_w_players <- fetch_data(base_url, headers, only_first_page = FALSE, is_team_players = TRUE) 
